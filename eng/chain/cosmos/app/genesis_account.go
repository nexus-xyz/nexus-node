...
type GenesisAccount struct {
	*authtypes.BaseAccount
	...
	OriginalVesting  sdk.Coins `json:"original_vesting" yaml:"original_vesting"`   // total vesting coins
	DelegatedFree    sdk.Coins `json:"delegated_free" yaml:"delegated_free"`       // delegated vested coins
	DelegatedVesting sdk.Coins `json:"delegated_vesting" yaml:"delegated_vesting"` // delegated vesting coins
	StartTime        int64     `json:"start_time" yaml:"start_time"`               // vesting start time
