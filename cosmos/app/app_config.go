...
var (
	moduleAccPerms = []*authmodulev1.ModuleAccountPermission{
		...
		{Account: minttypes.ModuleName, Permissions: []string{authtypes.Minter}},
		{
			...
			Permissions: []string{authtypes.Burner, authtypes.Minter, stakingtypes.ModuleName},
		},
		...
		Modules: []*appv1alpha1.ModuleConfig{
			{
				...
				Config: appconfig.WrapAny(&runtimev1alpha1.Module{
					...
					// BeginBlockers order is set manually in app.go (same pattern as
					// EndBlockers) so that we can register a custom BeginBlocker without
					// the runtime overriding it during Load.
